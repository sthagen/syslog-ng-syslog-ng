...
def test_logrotate_deleting_log_file(config, syslog_ng, teardown):
    ...
    assert wait_until_true(lambda: "processed" in file_destination.get_stats() and file_destination.get_stats()["processed"] == counter * 2)
